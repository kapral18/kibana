...
describe('Editor actions provider', () => {
  ...
  describe('provideCompletionItems', () => {
    ...
    it('284395 repro 1: SHOULD use body completion below an inline triple-quoted value', async () => {
    ...
    it('284395 repro 2: SHOULD use body completion after a closed multiline triple-quoted value', async () => {
