...
const getEmptyAutoFollowPattern = (remoteClusterName = ''): ParsedAutoFollowPattern => ({
  name: '',
  active: true,
...
interface Props {
  saveAutoFollowPattern: (name: string, autoFollowPattern: AutoFollowPatternConfig) => void;
...
export class AutoFollowPatternForm extends PureComponent<Props, State> {
  ...
  onFieldsChange = (fields: Partial<ParsedAutoFollowPattern>) => {
